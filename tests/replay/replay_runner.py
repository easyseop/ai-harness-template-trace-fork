...
Claude performs the actual stage replay from the slash command; this script keeps
the mechanical assertions deterministic and cheap.
"""
...
def main() -> int:
    ...
    parser.add_argument("--prepare-replay", action="store_true", help="Create run directory, lineage, and replay prompt for Claude-mediated replay")
