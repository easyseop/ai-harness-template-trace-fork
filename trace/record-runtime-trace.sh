...
add_if_exists ".claude/commands/$STEP.md" COMMAND_FILES
add_if_exists "commands/$STEP.md" COMMAND_FILES

case "$STEP" in
  interview)
    add_if_exists ".claude/agents/interviewer.md" PERSONA_FILES
    ...
    ;;
  seed)
    add_if_exists ".claude/agents/seed-architect.md" PERSONA_FILES
    add_if_exists ".claude/agents/ontologist.md" PERSONA_FILES
    ...
    ;;
  trd)
    add_if_exists ".claude/agents/architect.md" PERSONA_FILES
  ...
  decompose)
    ...
    ;;
  run)
    add_if_exists ".claude/agents/navigator.md" PERSONA_FILES
    add_if_exists ".claude/agents/test-designer.md" PERSONA_FILES
    ...
    ;;
  evaluate)
    add_if_exists ".claude/agents/evaluator.md" PERSONA_FILES
  ...
  evolve)
    for p in contrarian simplifier researcher architect hacker; do
      add_if_exists ".claude/agents/$p.md" PERSONA_FILES
